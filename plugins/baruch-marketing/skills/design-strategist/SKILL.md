...
description: |
  ...
  Outputs a Design Brief JSON that the baruch-design-agent consumes.
version: 1.0.0
---
...
3. **The orchestrator will automatically invoke** `/baruch-design-agent` in the SAME conversation

**NEVER output:**
- ❌ "העתק את ה-Design Brief"
- ❌ "פתח שיחה חדשה עם baruch-design-agent"
- ❌ "דרך 3 — בנייה"
...
### 1. WOW Dark Premium (Default "Baruch Style")
...
- `baruch-copy-agent` — generates the copy you analyze
- `baruch-design-agent` — builds the page from your brief
