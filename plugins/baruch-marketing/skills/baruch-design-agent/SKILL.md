...
- Building landing pages from copy JSON (output of baruch-copy-agent)
...
- After receiving copy JSON from baruch-copy-agent
...
### Color Palette (Dark Premium - "Baruch Style")
...
Use these as reference for the "Baruch Style" dark premium aesthetic.
